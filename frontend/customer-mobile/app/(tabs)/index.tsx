...
export default function CustomerHomeDashboard() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Alert Detail Modal */}
      <Modal visible={Boolean(selectedAlert)} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <View style={styles.modalTag}>
                <Text style={styles.modalTagText}>CDSCO ADVISORY</Text>
              </View>
            ...
            <Text style={styles.modalSource}>{selectedAlert?.source} • {selectedAlert?.date}</Text>
            <Text style={styles.modalBody}>{selectedAlert?.summary}</Text>
            <View style={styles.modalActionBox}>
              <Text style={styles.modalActionTitle}>Recommended Action:</Text>
              <Text style={styles.modalActionDesc}>{selectedAlert?.recommendedAction}</Text>
            </View>
            <TouchableOpacity
              style={styles.modalCloseBtn}
              onPress={() => setSelectedAlert(null)}
            >
              <Text style={styles.modalCloseBtnText}>Close Advisory</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
